...
def make_data_week_1_loc(file_path):
    data_dict = dict([])

    data_dict['linear_forward'] = create_linear_forward_loc()
    data_dict['linear_grad_W'] = create_linear_grad_W_loc()
    data_dict['linear_grad_b'] = create_linear_grad_b_loc()
    data_dict['sigmoid_forward'] = create_sigmoid_forward_loc()
    data_dict['sigmoid_grad_input'] = create_sigmoid_grad_input_loc()
    data_dict['nll_forward'] = create_nll_forward_loc()
    data_dict['nll_grad_input'] = create_nll_grad_input_loc()

    data_dict['tree_gini_index'] = create_tree_gini_index_loc()
    data_dict['tree_split_data_left'] = create_tree_split_data_left_loc()
    data_dict['tree_split_data_right'] = create_tree_split_data_right_loc()
    data_dict['tree_to_terminal'] = create_tree_to_terminal_loc()

    with open(file_path, 'wb') as f:
        pickle.dump(data_dict, f, protocol=2)


def make_data_week_1_2_loc(file_path):
    data_dict = dict([])
    data_dict['linear_forward'] = create_linear_forward_loc()
    data_dict['linear_grad_W'] = create_linear_grad_W_loc()
    data_dict['linear_grad_b'] = create_linear_grad_b_loc()
    ...
    data_dict['dense_forward'] = create_dense_forward_loc()
    data_dict['dense_grad_input'] = create_dense_grad_input_loc()
    data_dict['dense_grad_W'] = create_dense_grad_W_loc()
    data_dict['dense_grad_b'] = create_dense_grad_b_loc()
    data_dict['relu_forward'] = create_relu_forward_loc()
    data_dict['relu_grad_input'] = create_relu_grad_input_loc()
    data_dict['l2_regularizer'] = create_l2_regularizer_loc()
    data_dict['conv_matrix'] = create_conv_matrix_loc()
    data_dict['box_blur'] = create_box_blur_loc()
    data_dict['maxpool_forward'] = create_maxpool_forward_loc()
    data_dict['flatten_forward'] = create_flatten_forward_loc()
    data_dict['flatten_grad_input'] = create_flatten_grad_input_loc()

    with open(file_path, 'wb') as f:
        pickle.dump(data_dict, f, protocol=2)


def make_data_week_1_remote(file_path):
    data_dict = dict([])

    data_dict['linear_forward'] = create_linear_forward()
    data_dict['linear_grad_W'] = create_linear_grad_W()
    data_dict['linear_grad_b'] = create_linear_grad_b()
    data_dict['sigmoid_forward'] = create_sigmoid_forward()
    data_dict['sigmoid_grad_input'] = create_sigmoid_grad_input()
    data_dict['nll_forward'] = create_nll_forward()
    data_dict['nll_grad_input'] = create_nll_grad_input()

    data_dict['tree_gini_index'] = create_tree_gini_index()
    data_dict['tree_split_data_left'] = create_tree_split_data_left()
    data_dict['tree_split_data_right'] = create_tree_split_data_right()
    data_dict['tree_to_terminal'] = create_tree_to_terminal()

    with open(file_path, 'wb') as f:
        pickle.dump(data_dict, f, protocol=2)


def make_data_week_1_2_remote(file_path):
    data_dict = dict([])
    data_dict['linear_forward'] = create_linear_forward()
    data_dict['linear_grad_W'] = create_linear_grad_W()
    data_dict['linear_grad_b'] = create_linear_grad_b()
    ...
    data_dict['dense_forward'] = create_dense_forward()
    data_dict['dense_grad_input'] = create_dense_grad_input()
    data_dict['dense_grad_W'] = create_dense_grad_W()
    data_dict['dense_grad_b'] = create_dense_grad_b()
    data_dict['relu_forward'] = create_relu_forward()
    data_dict['relu_grad_input'] = create_relu_grad_input()
    data_dict['l2_regularizer'] = create_l2_regularizer()
    data_dict['conv_matrix'] = create_conv_matrix()
    data_dict['box_blur'] = create_box_blur()
    data_dict['maxpool_forward'] = create_maxpool_forward()
    data_dict['flatten_forward'] = create_flatten_forward()
    data_dict['flatten_grad_input'] = create_flatten_grad_input()
